...
"Simple competition model explains stable coexistence of hundreds of rainforest tree species"
...
* **turnover_subplot.r** - R code for calculating structural data and turnover rates of species populations.

* **skt.r** - R code for estimating species parameters and predicting a stable equilibrium solution in the competition model.
...
* **data/Pasoh_species.csv** - species code "Cd" in pfr.csv is related to species by "Family", "Genus", and "Species" (specific name)
...
The data files are licensed under the Creative Commons Attribution 4.0 International License, and the R codes are licensed under the [MIT License](LICENSE).
